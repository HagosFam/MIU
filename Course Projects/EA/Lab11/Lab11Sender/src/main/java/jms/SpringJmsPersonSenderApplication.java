...
public class SpringJmsPersonSenderApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Calcultor calcultor = new Calcultor("+", 6);
		ObjectMapper objectMapper1 = new ObjectMapper();
		String calculatorAsString = objectMapper1.writeValueAsString(calcultor);
		System.out.println("Sending number number and oprator" + calculatorAsString);
		jmsTemplate.convertAndSend("calculatorQueue", calculatorAsString);
